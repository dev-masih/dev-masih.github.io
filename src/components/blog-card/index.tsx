...
const staticArticles: Article[] = [
  {
    ...
    description: "Architected Filmnet VOD backend with C#/.NET microservices, hybrid VM/container infrastructure, and CI/CD pipelines. Optimized high-traffic performance for millions of users using MSSQL, Elasticsearch, RabbitMQ, and caching with in-memory and Redis clusters.",
